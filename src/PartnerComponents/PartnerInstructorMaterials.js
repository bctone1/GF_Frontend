            ...
            <div className="app">
                ...
                <main className="main">
                    ...
                    <div className="main-content">
                        ...
                        {/* Tab: Templates */}
                        <div className="partner-tab-content partner-tab-content--active" id="tab-templates">
                            <div className="stats-row">
                                <div className="stat-mini">
                        ...
                        {/* Tab: Few-shots */}
                        <div className="partner-tab-content partner-tab-content--active" id="tab-fewshots">
                            <div className="stats-row">
                                <div className="stat-mini">
