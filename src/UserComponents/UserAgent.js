            ...
            <div className="app">
                ...
                <main className="main">
                    ...
                    <div className="agent-content">
                        ...
                        <div id="mainView">
                            ...
                            <div className="agent-tabs-wrapper">
                                <div className="agent-tabs">
                                    <button className="agent-tab agent-tab--active" id="tabTemplate">
                                    ...
                                    <button className="agent-tab" id="tabMy">
                                        <svg className="icon icon--sm" viewBox="0 0 24 24">
                            ...
                            <div className="stats-bar" id="statsBar">
                                <div className="stats-bar__item">
                                    ...
                                    <div className="stats-bar__info">
                                        ...
                                        <span className="stats-bar__label">전체 에이전트</span>
                                    </div>
                                </div>
                                <div className="stats-bar__item">
                            ...
                            <div id="templateGrid">
                                ...
                                <div className="template-section">
                                    ...
                                    <div className="agent-grid">
                                        <div className="agent-card agent-card--template agent-card--blue" >
                                            <div className="agent-card__header">
                                                <div className="agent-card__name">
                                                    코딩 튜터
                                                    <span className="agent-card__badge agent-card__badge--template">템플릿</span>
                                                </div>
                                                <div className="agent-card__desc">Python, JavaScript 등 프로그래밍 언어를 친절하게 가르치는 튜터 에이전트입니다.</div>
                                            </div>
                                        ...
                                        <div className="agent-card agent-card--template agent-card--pink" >
                                            <div className="agent-card__header">
                                                <div className="agent-card__name">
                                                    콘텐츠 작가
                                                    <span className="agent-card__badge agent-card__badge--template">템플릿</span>
                                                </div>
                                                <div className="agent-card__desc">블로그, 마케팅 문구 등 다양한 콘텐츠를 작성하는 전문 작가 에이전트입니다.</div>
                                            </div>
                                            <div className="agent-card__footer-hint">
                                                <svg className="icon icon--sm" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                                클릭하여 프롬프트 구조 분석하기
                                        ...
                                        <div className="agent-card agent-card--template agent-card--green" >
                                            <div className="agent-card__header">
                                                <div className="agent-card__name">
                                                    전문 번역가
                                                    <span className="agent-card__badge agent-card__badge--template">템플릿</span>
                                                </div>
                                                <div className="agent-card__desc">영어, 일본어, 중국어 등 다국어 번역을 전문으로 하는 번역가 에이전트입니다.</div>
                                            </div>
                                            <div className="agent-card__footer-hint">
                                                <svg className="icon icon--sm" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                                클릭하여 프롬프트 구조 분석하기
                                    ...
                                    <div className="agent-grid">
                                        <div className="agent-card agent-card--template agent-card--orange" >
                                            <div className="agent-card__header">
                                                ...
                                                <div className="agent-card__desc">마케팅 데이터를 분석하고 캠페인 전략을 제안하는 분석 전문 에이전트입니다.</div>
                                            </div>
                                            <div className="agent-card__footer-hint">
                                                <svg className="icon icon--sm" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                                클릭하여 프롬프트 구조 분석하기
                                        ...
                                        <div className="agent-card agent-card--template agent-card--indigo" >
                                            <div className="agent-card__header">
                                                ...
                                                <div className="agent-card__desc">친절하고 전문적으로 고객 문의에 응대하는 CS 전문 에이전트입니다.</div>
                                            </div>
                                            <div className="agent-card__footer-hint">
                                                <svg className="icon icon--sm" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                                클릭하여 프롬프트 구조 분석하기
                        ...
                        <div className="template-detail" id="templateDetail">
                            ...
                            <div className="detail-card" id="detailCard">
                                <div className="detail-header">
                                    <div className="detail-info">
                                        ...
                                        <p className="detail-desc" id="detailDesc">Python, JavaScript 등 프로그래밍 언어를 친절하게 가르치는 튜터 에이전트입니다.</p>
                                    </div>
                                ...
                                <div className="detail-section">
                                    ...
                                    <div className="detail-section__content" id="detailPrompt">[역할 (Role)]
