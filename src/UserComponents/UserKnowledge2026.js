                        ...
                        <div className={`advanced-mode ${mainPageStatus === 'advanced' ? 'advanced-mode--active' : ''}`} id="advancedMode">
                            ...
                            <div className="step step--active" id="step1">
                                <div className="step-card">
                                    ...
                                    <div className="upload-zone" id="advancedUploadZone"
                                    >
                                        <input type="file" id="advancedFileInput" multiple accept=".pdf,.txt,.docx,.csv"
                                            style={{ display: 'none' }} />
                                        <div className="upload-zone__icon">
                                            <svg className="icon icon--lg" viewBox="0 0 24 24">
                                                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                                    ...
                                    <div className="step-actions">
                                        ...
                                        <button className="btn btn--primary" >다음 단계</button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="step-card__settings">
                                        ...
                                        <div className="form-row">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-input" id="segmentIdentifier"
                                                    placeholder="예: ###, ---" />
                                            ...
                                            <div className="form-group">
                                                ...
                                                <input type="number" className="form-input" id="maxChunkLength"
                                                    min="128" max="4096" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="number" className="form-input" id="chunkOverlap" min="0"
                                                max="200" style={{ maxWidth: '200px' }} />
